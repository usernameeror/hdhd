...
def menu():
    ...
    print(" \x1b[1;92m[\x1b[1;93m+\x1b[1;92m] \x1b[1;93m-------------------------------------------------------")
    print ('\n %s[ welcome %s%s%s ] \n'%(P,K,nama,P))
    print (' [%s01%s] \x1b[1;92mDump id teman/publik'%(K,P)) 
    print (' [%s02%s] \x1b[1;92mDump id teman/followers'%(K,P)) 
    print (' [%s03%s] \x1b[1;92mDump id reaction post'%(K,P))
    print (' [%s04%s] \x1b[1;92mCrack cari nama \x1b[1;93m(instagram) '%(K,P))
    print (' [%s05%s] %sStart crack %s'%(K,P,H,P)) 
    print (' [%s06%s] \x1b[1;92mSetting user agent'%(K,P)) 
    print (' [%s07%s] \x1b[1;92mCek hasil crack'%(K,P)) 
    print (' [%s08%s] \x1b[1;92mGabung group'%(K,P))
    print (' [%s09%s] \x1b[1;92mInfo script'%(K,P))
